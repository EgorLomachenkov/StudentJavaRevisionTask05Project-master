...
public class Task08 {
    public static String start(String color1, String color2) {
        if (color1 == null || color2 == null || !((color1.equals("red")
                || color1.equals("blue") || color1.equals("yellow"))
        ...
        if (color1.equals(color2)) {
            resultColor = color1;
                ...
                || color2.equals("red") && color1.equals("blue")) {
            resultColor = "violet";
        } else if (color1.equals("red") && color2.equals("yellow")
                || color2.equals("red") && color1.equals("yellow")) {
            resultColor = "orange";
        }
